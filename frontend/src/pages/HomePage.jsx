    ...
    const dataAnime = async () => {
      try {
        ...
        const latestAnime = data
          ...
          .sort((a, b) => {
            const dateA = new Date(a.aired.split(" - ")[0]);
            const dateB = new Date(b.aired.split(" - ")[0]);
            return dateB - dateA;
          })
          .slice(0, 6);
      ...
      <div className="home-container w-full flex flex-col items-center gap-8 sm:gap-10 justify-center pb-12 pt-24 bg-gray-50">
        ...
        <div className="intro w-[95%] min-h-fit lg:min-h-[70vh] bg-gradient-to-t from-blue-900 to-blue-950 shadow-xl border border-gray-200 rounded-2xl flex flex-col lg:flex-row items-center justify-around gap-8 lg:gap-10 py-12 lg:py-16 px-6 sm:px-10 relative overflow-hidden">
          ...
          <div className="text w-full lg:w-1/2 text-sky-100 text-center lg:text-left z-10">
            ...
            <p className="font-medium text-base sm:text-lg lg:text-xl text-sky-200/90 mb-8 max-w-2xl mx-auto lg:mx-0">
              Explore amazing stories, unforgettable characters, and countless
              worlds. Find your favorite anime and keep track of everything you
              love in one place.
            </p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-8">
              <a
                href="#explore"
                className="px-8 sm:px-10 py-3 text-lg font-bold bg-gradient-to-r from-indigo-500 hover:from-indigo-600 hover:to-purple-600 to-purple-500 rounded-lg text-white shadow-lg transition-all transform hover:-translate-y-1"
              >
                Explore Now
              </a>
              <a
                href="#ranking"
                className="px-5 py-3 text-lg bg-gradient-to-b from-yellow-400 hover:from-yellow-500 to-orange-500 font-bold rounded-lg text-white shadow-lg transition-all transform hover:-translate-y-1 flex items-center gap-2"
              >
        ...
        <div className="w-[95%] bg-white border border-gray-200 flex flex-col items-center py-8 sm:py-10 gap-6 rounded-2xl shadow-sm">
          <div className="w-[95%] flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 pb-4">
            ...
            <a href="/new-anime" className={seeMoreClass}>
          ...
          <div className="flex flex-col gap-6 w-full xl:w-[65%] bg-white border border-gray-200 rounded-2xl shadow-sm py-8 sm:py-10 px-4 sm:px-8">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-gray-100 pb-4">
              <div className="leading-tight">
                ...
                <p className="text-gray-500 text-xs sm:text-sm mt-1 ml-11">
                  Dipilih berdasarkan anime yang paling populer saat ini
                </p>
              </div>
              <a href="/ranking" className={seeMoreClass}>
                Lihat Peringkat <FontAwesomeIcon icon={faAnglesRight} />
              </a>
            </div>
              ...
              {animePopuler().map((top, index) => (
                ...
                >
                  ...
                  <div className="text-white py-2 pr-2 min-w-0 flex flex-col justify-between w-full">
                    <div>
                      <span
                        className={`${colorLinear2[index]} py-1 px-3 text-lg font-extrabold rounded-md border border-white/20 shadow-sm inline-block mb-3`}
                      >
                        #{index + 1}
                      </span>
                      <h2 className="text-base sm:text-lg font-open-sans font-bold mb-2 truncate drop-shadow-md">
                        {top.title}
                      </h2>
                      <ul className="flex flex-wrap gap-1.5 mb-2">
                        {top.genres?.slice(0, 2).map((genre) => (
                          <li
                            key={genre}
                            className="bg-black/20 backdrop-blur-sm text-[10px] sm:text-xs rounded-md border border-white/30 py-0.5 px-2"
                          >
                            {genre}
                          </li>
                        ))}
              ...
              {animeUpcoming.map((anime) => (
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    <h4 className="font-bold text-white text-sm sm:text-base truncate drop-shadow-md group-hover:text-sky-200 transition-colors">
                      {anime.title}
                    </h4>
        ...
        <div className="w-[95%] bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 rounded-2xl shadow-xl flex flex-col md:flex-row items-center justify-between p-8 sm:p-12 gap-10 text-white relative overflow-hidden">
          ...
          <div className="md:w-1/2 flex flex-col gap-4 text-center md:text-left z-10">
            ...
            <p className="text-sky-100 text-sm sm:text-base leading-relaxed">
              AnimeList adalah platform komunitas anime terlengkap yang
              didedikasikan untuk para penggemar budaya pop Jepang. Temukan
              serial baru, lacak progres tontonan Anda, baca ulasan, dan
              bergabunglah dalam diskusi bersama jutaan pecinta anime lainnya di
              seluruh dunia.
            </p>
            <div className="mt-2">
              <a
                href="/about"
                className="inline-block px-6 py-2 border-2 border-indigo-400 text-indigo-100 hover:bg-indigo-400 hover:text-white font-semibold rounded-lg transition-colors"
              >
