...
export default function Navbar(){
    ...
    return(
        <>
            <nav className="nav-container fixed  w-full h-17 flex items-center justify-between px-4 md:px-6 lg:px-8 bg-linear-to-l from-indigo-900 to-indigo-950">
                ...
                <div className="right-side hidden lg:flex items-center gap-6 xl:gap-10">
                    <div className="Navigasi">
                        <ul className="flex items-center gap-1 xl:gap-2 text-white font-semibold">
                            ...
                            <li className="hover:bg-purple-600 py-2 px-3 rounded-md transition-all ease-in duration-100"><a href="">Browse</a></li>
                            <li className="hover:bg-purple-600 py-2 px-3 rounded-md transition-all ease-in duration-100"><a href="">Category</a></li>
                            <li className="hover:bg-purple-600 py-2 px-3 rounded-md transition-all ease-in duration-100"><a href="">Rangkings</a></li>
                        </ul>
                    </div>
            ...
            <div className={`absolute right-4 top-20 w-15 bg-linear-to-b from-indigo-900 to-indigo-950 rounded-xl z-50 flex flex-col items-center py-5 gap-6 lg:hidden origin-top-right transition-all duration-200 ease-out ${isMenuOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}>
                <div className="flex flex-col items-center gap-2 w-full">
                    ...
                    <a href="" aria-label="Browse" className="w-10 h-10 flex items-center justify-center text-white hover:bg-purple-600 rounded-lg transition-all ease-in duration-100">
                        <FontAwesomeIcon icon={faCompass}/>
                    </a>
                    <a href="" aria-label="Category" className="w-10 h-10 flex items-center justify-center text-white hover:bg-purple-600 rounded-lg transition-all ease-in duration-100">
                        <FontAwesomeIcon icon={faLayerGroup}/>
                    </a>
                    <a href="" aria-label="Rangkings" className="w-10 h-10 flex items-center justify-center text-white hover:bg-purple-600 rounded-lg transition-all ease-in duration-100">
